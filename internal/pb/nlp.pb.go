...
type ParseResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ParsedData    string                 `protobuf:"bytes,1,opt,name=parsed_data,json=parsedData,proto3" json:"parsed_data,omitempty"` // JSON с извлеченными навыками
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_nlp_proto_rawDesc = "" +
	...
	"\n" +
	"NLPService\x122\n" +
	"\vParseResume\x12\x10.pb.ParseRequest\x1a\x11.pb.ParseResponseB+Z)github.com/moverq1337/VTBHack/internal/pbb\x06proto3"
...
var file_proto_nlp_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_nlp_proto_depIdxs = []int32{
	...
	1, // 1: pb.NLPService.ParseResume:output_type -> pb.ParseResponse
